...
const { postRecommenPlace, getRecommenPlace } = require('../controller/recommenController');
...
route.post('/destination/:tourism_id/recommendation', postRecommenPlace);
route.get('/home/recommendation', getRecommenPlace);
